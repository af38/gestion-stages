...
export class AdresseService {
  ...
  protected city = [
      ...
      },
      {
        ...
        "label": "Moulay Idriss Zerhoun"
      },
      {
        "id": "232",
        "name": "Moulay Yaâcoub",
        "label": "Moulay Yaâcoub"
      },
      {
        "id": "233",
        "name": "Moussaoua",
      ...
      },
      {
        ...
        "label": "Sidi Mohamed ben Abdallah el-Raisuni"
      },
      {
        "id": "306",
        "name": "Sidi Rahhal",
      ...
      },
      {
        ...
        "label": "Zaouia d'Ifrane"
      },
      {
        "id": "387",
        "name": "Zaouïat Cheikh",
        "label": "Zaouïat Cheikh"
      },
      {
        "id": "388",
        "name": "Zaïda",
  ...
  protected regions:any = this.region.map(e => {
    const {id, name, region} = e;
    return region;
  });

  // regions list
  protected villes:any = this.city.map(e => {
    const {id, name,label} = e;
    return label;
  });
